...
class gsp_global_sociocreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/socio/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(21)
invokeTag('all','f',55,['bean':("socioInstance")],-1)
printHtmlPart(22)
invokeTag('message','g',59,['code':("default.button.create.label"),'default':("Create")],-1)
printHtmlPart(23)
})
invokeTag('form','g',63,['class':("form-horizontal"),'action':("create"),'enctype':("multipart/form-data")],2)
printHtmlPart(24)
})
