...
class gsp_global_medicionedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/medicion/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'medicion.label', default: 'Medicion'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
createTagBody(2, {->
printHtmlPart(8)
invokeTag('message','g',25,['code':("default.create.label"),'args':([entityName])],-1)
printHtmlPart(6)
})
...
invokeTag('eachError','g',47,['bean':(medicionInstance),'var':("error")],4)
printHtmlPart(19)
})
invokeTag('alert','bootstrap',49,['class':("alert-error")],3)
printHtmlPart(11)
})
invokeTag('hasErrors','g',50,['bean':(medicionInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',54,['name':("version"),'value':(medicionInstance?.version)],-1)
printHtmlPart(22)
invokeTag('all','f',56,['bean':("medicionInstance")],-1)
printHtmlPart(23)
...
invokeTag('form','g',68,['class':("form-horizontal"),'action':("edit"),'id':(medicionInstance?.id)],2)
printHtmlPart(26)
})
