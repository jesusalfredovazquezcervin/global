...
class gsp_globalindex_gsp extends GroovyPage {
...
invokeTag('captureBody','sitemesh',800,['id':("page-top"),'class':("index")],1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1407129361000L
