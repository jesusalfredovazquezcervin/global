...
class gsp_global_usuarioedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',47,['bean':(usuarioInstance),'var':("error")],4)
printHtmlPart(19)
})
invokeTag('alert','bootstrap',49,['class':("alert-error")],3)
printHtmlPart(11)
})
invokeTag('hasErrors','g',50,['bean':(usuarioInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',54,['name':("version"),'value':(usuarioInstance?.version)],-1)
printHtmlPart(22)
invokeTag('all','f',56,['bean':("usuarioInstance")],-1)
printHtmlPart(23)
...
invokeTag('form','g',68,['class':("form-horizontal"),'action':("edit"),'id':(usuarioInstance?.id)],2)
printHtmlPart(26)
})
