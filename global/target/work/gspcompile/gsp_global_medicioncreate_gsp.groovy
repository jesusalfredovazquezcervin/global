...
class gsp_global_medicioncreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/medicion/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(21)
invokeTag('all','f',55,['bean':("medicionInstance")],-1)
printHtmlPart(22)
