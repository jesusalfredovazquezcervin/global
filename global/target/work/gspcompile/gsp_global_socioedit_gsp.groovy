...
class gsp_global_socioedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/socio/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'socio.label', default: 'Socio'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',47,['bean':(socioInstance),'var':("error")],4)
printHtmlPart(19)
})
invokeTag('alert','bootstrap',49,['class':("alert-error")],3)
printHtmlPart(11)
})
invokeTag('hasErrors','g',50,['bean':(socioInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',54,['name':("version"),'value':(socioInstance?.version)],-1)
printHtmlPart(22)
invokeTag('all','f',56,['bean':("socioInstance")],-1)
printHtmlPart(23)
...
invokeTag('form','g',68,['class':("form-horizontal"),'action':("edit"),'id':(socioInstance?.id),'enctype':("multipart/form-data")],2)
printHtmlPart(26)
})
