...
class gsp_global_membresiaedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/membresia/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'membresia.label', default: 'Membresia'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',47,['bean':(membresiaInstance),'var':("error")],4)
printHtmlPart(19)
})
invokeTag('alert','bootstrap',49,['class':("alert-error")],3)
printHtmlPart(11)
})
invokeTag('hasErrors','g',50,['bean':(membresiaInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',54,['name':("version"),'value':(membresiaInstance?.version)],-1)
printHtmlPart(22)
invokeTag('all','f',56,['bean':("membresiaInstance")],-1)
printHtmlPart(23)
...
invokeTag('form','g',68,['class':("form-horizontal"),'action':("edit"),'id':(membresiaInstance?.id)],2)
printHtmlPart(26)
})
