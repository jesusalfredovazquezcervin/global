...
class gsp_global_mensualidadedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/mensualidad/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',6,['var':("entityName"),'value':(message(code: 'mensualidad.label', default: 'Mensualidad'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',47,['bean':(mensualidadInstance),'var':("error")],4)
printHtmlPart(19)
})
invokeTag('alert','bootstrap',49,['class':("alert-error")],3)
printHtmlPart(11)
})
invokeTag('hasErrors','g',50,['bean':(mensualidadInstance)],2)
printHtmlPart(20)
createTagBody(2, {->
printHtmlPart(21)
invokeTag('hiddenField','g',54,['name':("version"),'value':(mensualidadInstance?.version)],-1)
printHtmlPart(22)
invokeTag('all','f',56,['bean':("mensualidadInstance")],-1)
printHtmlPart(23)
...
invokeTag('form','g',68,['class':("form-horizontal"),'action':("edit"),'id':(mensualidadInstance?.id)],2)
printHtmlPart(26)
})
