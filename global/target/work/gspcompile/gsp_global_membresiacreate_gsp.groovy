...
class gsp_global_membresiacreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/membresia/create.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(21)
invokeTag('all','f',55,['bean':("membresiaInstance")],-1)
printHtmlPart(22)
